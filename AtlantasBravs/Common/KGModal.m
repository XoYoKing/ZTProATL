...
@property (nonatomic, strong) KGModalGradientView *styleView;
@end

@interface KGModal()
@property (strong, nonatomic) UIWindow *window;
@property (nonatomic, strong) KGModalViewController *viewController;
@property (nonatomic, strong) KGModalContainerView *containerView;
@property (nonatomic, strong) KGModalCloseButton *closeButton;
@property (nonatomic, strong) UIView *contentView;
@property (nonatomic, strong) UIView *parentView;
@property (nonatomic, unsafe_unretained) id<KGModalDelegate> delegate_;
@end
...
- (void)setKGDelegate:(id<KGModalDelegate>)delegate
{
...
- (void)showWithContentView:(UIView *)contentView{
    [self showWithContentView:contentView andAnimated:YES andParent:NULL andDelegate:NULL];
}

- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated andParent:(UIView *)parentV andDelegate:(id<KGModalDelegate>)delegate{
    ...
    containerViewRect.origin.x = round(CGRectGetMidX(pView.bounds)-CGRectGetMidX(containerViewRect));
    containerViewRect.origin.y = round(CGRectGetMidY(pView.bounds)-CGRectGetMidY(containerViewRect));
...
- (id)init{
    if(!(self = [super initWithFrame:(CGRect){295, 0, 32, 32}])){
        return nil;
    }
